    ...
    <aside className="hidden lg:block fixed left-0 top-0 z-30 h-full w-[320px] border-r border-slate-200 bg-white/95 backdrop-blur-sm">
      <div className="h-full flex flex-col pt-20">
        <div className="border-b border-slate-100 px-3 py-2.5">
          <button
            onClick={onReset}
            className="w-full inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50"
          >
