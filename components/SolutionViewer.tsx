...
const SolutionViewer: React.FC<SolutionViewerProps> = ({ solution, onReset }) => {
  ...
  if (showSummary) {
    return (
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 max-w-4xl w-full mx-auto">
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Progress Bar */}
      <div className="mb-6 w-full bg-slate-200 rounded-full h-2.5 overflow-hidden">
        <div 
